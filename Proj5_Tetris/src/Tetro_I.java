 ...
 * DESCRIPTION: Tetro_L.java : Class which will implement TetroShape ---> for 'I' 
 ********************************************************************************/
public class Tetro_I extends Tetromino implements TetroShape {
	 ...
	 public char[][] shapeA() {
		...
		public void cut(block grid[][]) {
			...
			for(int i=0; i<4; i++)
				for(int j=0; j<4; j++)
				{	
					if(shapeArea[i][j] == 'i' && position.y+i>=0)
					{
